...
| ------------------------------- | ------------- | ------  | ----------------------------------------------------------------------------- | 
| BillingAddress                  | No            | String  | A complex type that contains the following address information for the account: <br/> &nbsp; &nbsp; 1. address1 – The first address line for the billing address. <br/> &nbsp; &nbsp; 2. address2 – An additional address line for the billing address. <br/> &nbsp; &nbsp; 3. city – The city for the billing address. <br/> &nbsp; &nbsp; 4. state – The state for the billing address, see note below. <br/> &nbsp; &nbsp; 5. postalCode – The postal code for the billing address. <br/> &nbsp; &nbsp; 6. phone – The telephone number for the billing address. <br/> &nbsp; &nbsp; 7. fax – The fax number for the billing address. <br/> &nbsp; &nbsp; 8. country – The country code for the billing address, see note below. <br/> &nbsp; &nbsp; 9. firstName – The first name of a contact person associated with the &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; billing address. <br/> &nbsp; &nbsp; 10. lastName – The last name of a contact person associated with the &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; billing address. <br/> &nbsp; &nbsp; 11. email – The email address associated with the billing address. <br/> <br/> **Note:** If country is US (United States) then State codes are validated for US States. Otherwise, State is treated as a non-validated string and serves the purpose of entering a state/province/region.
| CreditCardInformation           | No            | String  | A complex type that has information about the credit card used to pay for this account. It included the elements:  <br/> &nbsp; &nbsp; &nbsp; 1. cardNumber – The credit card number. Note that in responses only the last four digits are shown. <br/> &nbsp; &nbsp; &nbsp; 2. expirationMonth – The expiration month shown on the credit card. <br/> &nbsp; &nbsp; &nbsp; 3. expirationYear – The expiration year shown on the credit card. <br/> &nbsp; &nbsp; &nbsp; 4. nameOnCard – The name listed on the credit card. <br/> &nbsp; &nbsp; &nbsp; 5. cardType – The credit card type can be: visa, mastercard, or amex. <br/> address – A complex element with the credit card billing address information. This can be the same as billing address and follows the same rules as billingAddress. It contains the following elements: street1, street2, city, state, zip, zipPlus4, phone, fax, and country.
...
| RenewalStatus                   | No            | String  | Sets the renewal status for the account. The acceptable values are: <br/> &nbsp; &nbsp; &nbsp; 1. auto: The account automatically renews. <br/> &nbsp; &nbsp; &nbsp; 2. queued_for_close: Account will be closed at the billingPeriodEndDate. <br/> &nbsp; &nbsp; &nbsp; 3. queued_for_downgrade: Account will be downgraded at the billingPeriodEndDate. |
